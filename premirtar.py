...
with open(args.miRNA) as file, open(args.transcritome) as file:
    ...
    os.system("bowtie-build --threads 24 -q %s bowtie" %(args.transcritome))
    ...
    all_mir = r"%s/output/all_mir.fa" %(pathlib.Path().absolute())
